...
class Message(object):
    ...
    def apply_pad(self, pad):
        ...
        '''
        ciphertext = ''.join(self.shift_char(self.input_text[i], pad[i]) for i in range(len(self.input_text)))
        return ciphertext
...
class PlaintextMessage(Message):
    ...
    def generate_pad(self):
        ...
        '''
        return [random.randint(0, 109) for _ in range(len(self.input_text))]
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        '''
        decrypted_text = ''.join(self.shift_char(self.input_text[i], -pad[i]) for i in range(len(self.input_text)))
